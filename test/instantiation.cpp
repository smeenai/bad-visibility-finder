...
// CHECK: c::f at [[PATH:.*]]instantiation.cpp:[[@LINE-4]] (from specialization at [[PATH]]instantiation.cpp:[[@LINE+2]])
// CHECK-NOT: c::g
extern template class __attribute__((__visibility__("default"))) c<int>;

// CHECK: c::h at [[PATH]]instantiation.cpp:[[@LINE+1]] (from specialization at [[PATH]]instantiation.cpp:[[@LINE-2]])
